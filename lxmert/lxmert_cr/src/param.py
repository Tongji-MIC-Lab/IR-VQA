...
def parse_args():
    ...
    parser.add_argument('--ls_neg', type=float, default=1)
    parser.add_argument('--ls_flat', type=float, default=1)
    ...
    #Specific
    parser.add_argument('--alpha_cluster', type=float, default=1e-4, help='')
    parser.add_argument('--act_scale', type=int, default=1, help='')
    parser.add_argument('--cc', type=str, default='shuo ming', help='Load the model (usually the fine-tuned model).')
